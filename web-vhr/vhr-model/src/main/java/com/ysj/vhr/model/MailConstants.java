...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "ysj.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "ysj.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "ysj.mail.routing.key";
}
